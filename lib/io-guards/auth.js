 ...
 */
export const generateJwtToken = (payload, addPrefix = true) => {
 ...
 */
export const parseJwtToken = async (token, usePrefix = false) => {
  const jwtErrors = {
  ...
  try {
    ...
    if (usePrefix && prefix.length && tokenPrefix !== prefix) {
